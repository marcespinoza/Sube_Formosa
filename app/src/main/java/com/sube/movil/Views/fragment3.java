 ...
 * Created by Marcelo
 */
public class fragment3 extends Fragment implements SaldoFragment.View {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      /*  fab = rootView.findViewById(R.id.fab);
        ...
        /*new FancyShowCaseView.Builder(getActivity())
                .focusOn(rootView.findViewById(R.id.fab))
                .title("Ahora puedes guardar tus datos de inicio de sesión")
                .build()
                .show();*/
        presenter = new DatosLoginPresenter(this);
